...
fn run_lab4() {
    ...
    telemetry::event("lab4", "allocator-ready");
    ...
    telemetry::event("lab4", "root-page-table");
    ...
    telemetry::event("lab4", "text-mapped");
    if memory_set
    ...
    telemetry::event("lab4", "rodata-mapped");
    if memory_set
    ...
    telemetry::event("lab4", "data-mapped");
    if memory_set
    ...
    telemetry::event("lab4", "bss-mapped");
    ...
    telemetry::event("lab4", "user-pages-mapped");
    ...
    telemetry::event("lab4", "page-table-built");
    let _satp = runtime.activate();
    console::print_line("[Lab4] satp activated");
    telemetry::event("lab4", "satp-activated");
...
fn run_lab6() {
    ...
    if user::starter_interfaces_are_present() && syscall::starter_interfaces_are_present() {
        ...
        telemetry::event("lab6", "user-context-ready");
        telemetry::event("lab6", "entering-user");
