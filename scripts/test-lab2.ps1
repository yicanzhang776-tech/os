...
if ($ExpectIncomplete) {
    ...
    $stage1Markers = @("[Lab2] trap entry installed")
    $stage2Markers = $stage1Markers + @("[Lab2] triggering breakpoint exception", "[Lab2] trap: breakpoint exception")
    $stage3Markers = $stage2Markers + @("[Lab2] PASS")
