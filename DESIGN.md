...
为说明学校现有 MIT xv6 平台、赛题参考的 rCore/LearningOS 环境与本项目之间的关系，仓库补充了[三方教学实验环境比较](docs/three-way-comparison.md)。比较统一使用知识覆盖、实验组织、测试反馈、运行可观察性、教师验收、反馈闭环和智能辅助等指标，并明确区分公开资料借鉴、未直接复制的内容和本队增量工作。
